...
def determine_p2_score(encrypted_strategy_guide):
    ...
    for item in encrypted_strategy_guide:
        ...
        if my_strategy == "X":
            ...
            my_choice = list(winning_scenarios.keys())[
                list(winning_scenarios.values()).index(elf_choice)
            ]
            score += my_choice.value
            score += Points.WIN.value
...
if __name__ == "__main__":
    with open(
        "C:/Users/joshu/OneDrive/Desktop/Github/Advent/Advent of Code/2022/Day2/input.txt",
        "r",
    ) as f:
